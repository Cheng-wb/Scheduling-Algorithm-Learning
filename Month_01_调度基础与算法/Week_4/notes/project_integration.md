...
> 来源：原第三周 Day 7。按主题归档；旧实验数字仍对应文中配置，不代表新计划的未完成验收已通过。
...
| `experiments/integrated_demo.py` | 组织完整实验、比较方法、展示最好排程 |
...
```powershell
python "projects/search_lab/experiments/integrated_demo.py"
```
