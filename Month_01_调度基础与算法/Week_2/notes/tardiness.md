...
> 来源：原第二周 Day 4。按主题归档；旧实验数字仍对应文中配置，不代表新计划的未完成验收已通过。
...
今天的代码入口是 [tardiness.py](../../../projects/scheduling_basics/experiments/tardiness.py)，核心模型在 [single_machine.py](../../../projects/scheduling_basics/scheduling/exact/single_machine.py)。
...
```powershell
python -m experiments.tardiness
```
