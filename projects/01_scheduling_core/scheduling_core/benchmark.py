"""python -m scheduling_core.benchmark --config configs/month1.json。"""
...
from .oracle import exhaustive_optimum
from .parser import save_json_instance
from .search import ALGORITHMS, SearchConfig, solve
...
def source_hash() -> str:
    ...
    for path in sorted((ROOT / "scheduling_core").glob("*.py")):
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts" / "month1")
